...
public class RptCliente {
    ...
    public StreamResource clienteAlCorte(Date fecha, Connection dataSource) {
...
//             Cargar el archivo .jasper desde el classpath
            InputStream reportStream = getClass().getResourceAsStream("/reporte/cliente/RptCliente.jasper");
