 ...
 * @author Maximiliano
 */
public class RptFinanza {

    public RptFinanza() {
    }


    public StreamResource estadoResultadoGerencial(Date fecha, Connection dataSource) {
...
//             Cargar el archivo .jasper desde el classpath
            InputStream reportStream = getClass().getResourceAsStream("/reporte/finanza/RptEStadoResultadoGerencial.jasper");
