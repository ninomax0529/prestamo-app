...
public class TipoPrestamo implements Serializable {
    ...
    public TipoPrestamo(Integer codigo) {
        this.codigo = codigo;
    }

    public TipoPrestamo(Integer codigo, String nombre, Date fechaCreacion, boolean habilitado) {
        this.codigo = codigo;
        this.nombre = nombre;
    ...
    public String toString() {
        return "com.maxsoft.application.modelo.TipoPrestamo[ codigo=" + codigo + " ]";
    }
